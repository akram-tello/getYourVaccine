        ...
        <div class="row">
            <div class="col-lg-3 col-xs-4 col-sm-12 logo-col">
                <div class="logo animated fadeInLeft">
                    <h1><a   style="padding:15px;background-color:#3CB64C;color:white; font-family: Georgia Header;border-radius:50px 0px 50px 0px" href="index.php">getYourVaccine</a></h1>
                </div>
            </div>
